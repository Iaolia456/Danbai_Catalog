...
function checkAppear(appearance_arr) {
	...
	if (appearance_arr.length == 0) {
		appearance = "'Mobile Suit Gundam', 'Mobile Suit Zeta Gundam', 'Mobile Suit Gundam ZZ', 'Mobile Suit Gundam: Chars Counterattack','Mobile Suit Gundam Unicorn', 'New Mobile Report Gundam Wing', 'Mobile Suit Gundam Wing','Mobile Suit Gundam Wing: Endless Waltz','New Mobile Report Gundam Wing: Endless Waltz', 'After War Gundam X','Mobile Suit Gundam SEED', 'Mobile Suit Gundam SEED Destiny', 'Mobile Suit Gundam OO'"
	}
	else {
